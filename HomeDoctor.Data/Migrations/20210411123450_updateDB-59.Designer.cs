...
namespace HomeDoctor.Data.Migrations
{
    ...
    [Migration("20210411123450_updateDB-59")]
    partial class updateDB59
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HomeDoctor.Data.Models.MedicalInstructionShareContract", b =>
                {
                    b.Property<int>("MedicalInstructionShareContractId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .UseIdentityColumn();
                    ...
                    b.HasKey("MedicalInstructionShareContractId");
                    ...
                    b.ToTable("MedicalInstructionShareContract");
                });
            ...
            modelBuilder.Entity("HomeDoctor.Data.Models.Appointment", b =>
                {
                    b.HasOne("HomeDoctor.Data.Models.MedicalInstruction", "MedicalInstruction")
                        .WithOne("Appointment")
                        .HasForeignKey("HomeDoctor.Data.Models.Appointment", "MedicalInstructionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("HomeDoctor.Data.Models.MedicalInstructionShareContract", b =>
                {
                    b.HasOne("HomeDoctor.Data.Models.Contract", "Contract")
                        .WithMany("MedicalInstructionShareContracts")
                        .HasForeignKey("ContractId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HomeDoctor.Data.Models.Disease", "Disease")
                        .WithMany("MedicalInstructionShareContracts")
            ...
            modelBuilder.Entity("HomeDoctor.Data.Models.Contract", b =>
                {
                    ...
                    b.Navigation("MedicalInstructionShareContracts");
                });
